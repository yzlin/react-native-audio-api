...
namespace audiocontext
{
    ...
    BiquadFilterNodeHostObject::BiquadFilterNodeHostObject(const std::shared_ptr<BiquadFilterNodeWrapper> &wrapper) : AudioNodeHostObject(wrapper) {
    ...
    std::vector<jsi::PropNameID> BiquadFilterNodeHostObject::getPropertyNames(jsi::Runtime &runtime)
    {
    ...
    jsi::Value BiquadFilterNodeHostObject::get(jsi::Runtime &runtime, const jsi::PropNameID &propNameId)
    {
    ...
    void BiquadFilterNodeHostObject::set(jsi::Runtime &runtime, const jsi::PropNameID &propNameId, const jsi::Value &value)
    {
        auto propName = propNameId.utf8(runtime);
