...
std::shared_ptr<IOSAudioBuffer> IOSAudioContext::createBuffer(int numberOfChannels, int length, int sampleRate)
{
  auto buffer = [audioContext_ createBuffer:numberOfChannels length:length sampleRate:sampleRate];
