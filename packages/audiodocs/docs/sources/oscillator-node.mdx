...
[`BaseAudioContext.createOscillator(options)`](/docs/core/base-audio-context#createoscillator)
...
| :---: | :---: | :---- |
| `wave` | `PeriodicWave` | Data representing custom wave. [`See for reference`](/docs/core/base-audio-context#createperiodicwave) |
...
- Nominal range is: -sampleRate/2 to sampleRate/2 (`sampleRate` value is taken from [`AudioContext`](/docs/core/base-audio-context#properties))
