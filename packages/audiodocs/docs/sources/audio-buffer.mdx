...
It can be created from audio file using [`BaseAudioContext.decodeAudioDataSource`](/core/base-audio-context#decodeaudiodatasource) or from raw data using [constructor](/sources/audio-buffer#constructor).
...
Above method returns array with PCM data from given channel.
...
Above method copies data from given channel of the `AudioBuffer` to an array.

| Parameters | Type | Description |
| :---: | :---: | :---- |
| `destination` | `number[]` | The array to which data will be copied. |
...
Above method copies data from given array to specified channel of the `AudioBuffer`.

| Parameters | Type | Description |
| :---: | :---: | :---- |
| `source` | `number[]` | The array from which data will be copied. |
