...
[`BaseAudioContext.createBufferSource(options)`](/docs/core/base-audio-context#createbuffersource)
...
The above method schedules `AudioBufferSourceNode` to start playback of audio data contained in the associated [`AudioBuffer`](/docs/sources/audio-buffer), or starts to play immediately.
...
## AudioBufferSourceNode Playground

This is an interactive example demonstrating the AudioBufferSourceNode. You can adjust the parameters in real-time to hear and see how they affect the generated sound wave.
