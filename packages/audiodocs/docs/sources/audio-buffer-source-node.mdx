...
| `detune` | [`AudioParam`](/core/audio-param) | [`k-rate`](/core/audio-param#a-rate-vs-k-rate) `AudioParam` representing detuning of playback in cents. |
...
- Nominal range is -∞ to ∞.
- Along with `playbackRate`, it determines speed of audio playback.
...
- Nominal range is -∞ to ∞.
- Along with `detune`, it determines speed of audio playback.
- 1.0 plays audio at normal speed, 2.0 plays audio twice as fast as normal speed.
