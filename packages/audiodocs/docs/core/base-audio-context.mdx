...
- Source nodes (e.g [`AudioBufferSourceNode`](/sources/audio-buffer-source-node), [`OscillatorNode`](/sources/oscillator-node))
- Effect nodes (e.g [`GainNode`](/effects/gain-node), [`BiquadFilterNode`](/sources/biquad-filter-node))
- Analysis nodes (e.g [`AnalyserNode`](/analysis/analyser-node))
- Destination nodes (e.g [`AudioDestinationNode`](/destinations/audio-destination-node))
...
:::info
Concept of system-level audio callback do not apply to [`OfflineAudioContext`](/core/offline-audio-context)
:::
...
| `destination` | [`AudioDestinationNode`](/core/audio-destination-node) | Final output destination associated with the context. | <ReadOnly /> |
...
Above method lets you create [`AnalyserNode`](/analysis/analyser-node).
