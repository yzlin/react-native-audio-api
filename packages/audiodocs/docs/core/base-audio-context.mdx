...
Above method lets you create `BiquadFilterNode`.
...
Above method lets you create `OscillatorNode`.

#### Returns `OscillatorNode`.

### `createPeriodicWave`

Above method lets you create `PeriodicWave`.
...
Above method lets you create `StereoPannerNode`.

#### Returns `StereoPannerNode`.

### `decodeAudioDataSource`

Above method lets you decode audio data file. It saves file in the device file system.
...
Above method lets you decode audio data. It decodes with in memory audio data block.
